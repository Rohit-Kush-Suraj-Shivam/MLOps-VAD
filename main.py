...
async def predict(file: UploadFile = File(...)):
    ...
    # Validate file type up front — return 400 for anything that isn't audio
    ...
    try:
        ...
        result = {
            "prediction": "Speech" if prediction == 1 else "Noise",
            "label": int(prediction),
            "confidence": round(confidence, 4),
            "speech_probability": round(float(probabilities[1]), 4),
